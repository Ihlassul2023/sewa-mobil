...
<form action="/mobil" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3 mt-3">
      ...
      <div id="imagePreview" class="image-preview">Preview</div>
    </div>
    @error('photo')
        <div class="alert alert-danger">
            {{ $message }}
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="number" name="tarif_sewa_per_hari" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
